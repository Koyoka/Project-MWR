<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/MasterPages/MWBOEmpty.Master" AutoEventWireup="true" CodeBehind="PostLog.aspx.cs" Inherits="YRKJ.MWR.BackOffice.Pages.BO.Inventory.PostLog" %>
	    ...
	    <div class="portlet box blue">
		    ...
		    <div class="portlet-body">
                <form data-wgt="mw-submit-group" 
                        ...
                        action="<% = WebAppFn.GetBoFullPageUrl(RedirectHelper.PostLog) %>">
			    ...
			    <table data-wgt="mw-expandtable-ajaxchild" 
                    data-wgt-submit-url="<% = WebAppFn.GetBoFullPageUrl(RedirectHelper.PostLog) %>" 
			    ...
			    <tbody>
                    <%
                        foreach (var item in PagePostInvTrackDatalist)
	{
                    %>
                <tr>
                    <td>
