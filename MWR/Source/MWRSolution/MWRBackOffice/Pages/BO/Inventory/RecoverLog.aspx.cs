...
{
    public partial class RecoverLog : BasePage
    {
        public const string ClassName = "YRKJ.MWR.BackOffice.Pages.BO.Inventory.RecoverLog";
        ...
        private bool LoadData_InvTrackData(int page, string filter, ref string errMsg)
        {
            ...
            long pageCount = 0;
            long rowCount = 0;
            if (!ReportDataMng.GetRecoverInventoryTrack(filter, page, pageSize, ref pageCount, ref rowCount, ref PageRecoverInvTrackDatalist, ref errMsg))
            {
                return false;
            }
        ...
        #region PageDatas
        protected List<TblMWInventoryTrack> PageRecoverInvTrackDatalist = new List<TblMWInventoryTrack>();
