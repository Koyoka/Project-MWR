...
{
    public partial class DestroyLog : BasePage
    {
        public const string ClassName = "YRKJ.MWR.BackOffice.Pages.BO.Inventory.DestroyLog";
        ...
        private bool LoadData_InvTrackData(int page, string filter, ref string errMsg)
        {
            ...
            long pageCount = 0;
            long rowCount = 0;
            if (!ReportDataMng.GetDestroyInventoryTrack(filter,page, pageSize, ref pageCount, ref rowCount, ref PageDestroyInvTrackDatalist, ref errMsg))
            {
                return false;
            }
        ...
        #region PageDatas
        protected List<TblMWInventoryTrack> PageDestroyInvTrackDatalist = new List<TblMWInventoryTrack>();
