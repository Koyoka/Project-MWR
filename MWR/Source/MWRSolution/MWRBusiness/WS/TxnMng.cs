    ...
    public class TxnMng
    {
            ...
            ref string errMsg)
        {
...
#endif
            {
                ...
                if (InvAuth != null)
                {
                    errMsg = LngRes.MSG_Valid_TxnInAuthorize; //"当前货箱审核未完成";
                    return false;
                }
        ...
        public static bool GetProcessingPostTxnList(string wscode, ref List<TblMWTxnPostHeader> header, ref string errMsg)
        {
            ...
            sqm.Condition.Where.AddCompareValue(TblMWTxnPostHeader.getStatusColumn(), SqlCommonFn.SqlWhereCompareEnum.UnEquals, TblMWTxnPostHeader.POSTTYPE_ENUM_Auto);
        ...
        public static bool BeginOperatePostTxn(string wsCode, string empyCode, ref string newTxnNum, ref string errMsg)
        {
            DataCtrlInfo dcf = new DataCtrlInfo();
        ...
        #region workflow 1
        public static bool ConfirmInventoryToPost(int invRecordId, string txnNum,decimal txnWeight, string wsCode, string empyCode, ref string errMsg)
        {
        ...
        #region workflow 2
        public static bool ConfirmInventoryToAuthorize(int invRecordId, string txnNum, decimal txnWeight, string wsCode, string empyCode, 
            ref int reInvAuthId, 
            ref string errMsg)
        {
            DataCtrlInfo dcf = new DataCtrlInfo();
