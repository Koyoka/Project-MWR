...
namespace YRKJ.MWR
{
    public class TblMWCrateCtrl : BaseDataCtrl
    {
        public static bool QueryPage(DataCtrlInfo dcf, SqlWhere sw, int page, int pageSize, ref List<TblMWCrate> itemList, ref string errMsg)
        {
        ...
        public static bool QueryPage(DataCtrlInfo dcf, SqlQueryMng sqm, int page, int pageSize,ref List<TblMWCrate> itemList,ref string errMsg)
        {
            try
            {
                ...
                itemList = SqlDBMng.getInstance().query(sql, new TblMWCrate(), sqm.getParamsArray());
                if (itemList.Count != 0)
                {
        ...
        public static bool QueryMore(DataCtrlInfo dcf, SqlWhere sw,ref List<TblMWCrate> itemList,ref string errMsg)
        {
            SqlQueryMng sqm = new SqlQueryMng();
            sqm.Condition.Where.AddWhere(sw);
        ...
        public static bool QueryMore(DataCtrlInfo dcf, SqlQueryMng sqm,ref List<TblMWCrate> itemList,ref string errMsg)
        {
        ...
        public static bool QueryOne(DataCtrlInfo dcf, SqlQueryMng sqm,ref TblMWCrate item,ref string errMsg)
        {
        ...
        public static bool QueryOne(DataCtrlInfo dcf, SqlWhere sw,ref TblMWCrate item, ref string errMsg)
        {
            SqlQueryMng sqm = new SqlQueryMng();
            sqm.Condition.Where.AddWhere(sw);
        ...
        public static bool Update(DataCtrlInfo dcf, TblMWCrate item, SqlUpdateColumn suc, SqlWhere sw,ref int count,ref string errMsg)
        {
            if (suc.Columns == null)
                 return true;
