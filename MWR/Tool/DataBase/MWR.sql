...
CREATE TABLE IF NOT EXISTS `MWRData`.`MWInventory` (
  ...
  `RecoWeight` DECIMAL(2) NULL COMMENT '回收重量',
  `InvWeight` DECIMAL(2) NULL COMMENT '库存重量',
  `PostWeight` DECIMAL(2) NULL COMMENT '出库重量',
  `DestWeight` DECIMAL(2) NULL COMMENT '销毁重量',
...
CREATE TABLE IF NOT EXISTS `MWRData`.`MWTxnRecoverHeader` (
  ...
  `StratDate` DATETIME NULL COMMENT '开始时间',
  `EndDate` DATETIME NULL COMMENT '结束时间',
  `OperateType` VARCHAR(2) NULL COMMENT '处理类型-\n1.回收入库  I\n2.直接处置  D',
  `TotalCrateQty` INT NULL COMMENT '交易中箱子的总重量',
  `TotalSubWeight` DECIMAL(2) NULL COMMENT '回收提交的总重量',
  `TotalTxnWeight` DECIMAL(2) NULL COMMENT '交易完成的实际总重量',
...
CREATE TABLE IF NOT EXISTS `MWRData`.`MWInventoryTrack` (
  ...
  `TxnNum` INT NULL COMMENT '库存变更执行的交易流水号',
  ...
  `Waste` VARCHAR(45) NULL COMMENT '废品名称',
  `WasteCode` VARCHAR(20) NULL COMMENT '废品编号',
  `SubWeight` DECIMAL(2) NULL COMMENT '库存变更的提交重量',
  `TxnWeight` DECIMAL(2) NULL COMMENT '库存变更的成交重量',
...
CREATE TABLE IF NOT EXISTS `MWRData`.`MWTxnPostHeader` (
  ...
  `TotalCrateQty` INT NULL COMMENT '交易中箱子的总重量',
  `TotalSubWeight` DECIMAL(2) NULL COMMENT '出库提交的总重量',
  `TotalTxnWeight` DECIMAL(2) NULL COMMENT '交易完成的实际总重量',
  `Status` VARCHAR(2) NULL COMMENT '出库交易的状态\n1.处理中\n2.完成\n3.审核中',
...
CREATE TABLE IF NOT EXISTS `MWRData`.`MWTxnDestroyHeader` (
  ...
  `StratDate` DATETIME NULL COMMENT '交易开始的时间',
  ...
  `TotalSubWeight` DECIMAL(2) NULL COMMENT '销毁提交的总重量',
  `TotalTxnWeight` DECIMAL(2) NULL COMMENT '交易完成的实际总重量',
...
CREATE TABLE IF NOT EXISTS `MWRData`.`MWInvAuthorize` (
  ...
  `SubWeight` DECIMAL(2) NULL COMMENT '提交的重量',
  `TxnWeight` DECIMAL(2) NULL COMMENT '交易中实际的重量',
  `DiffWeight` DECIMAL(2) NULL COMMENT '重量差值',
...
CREATE TABLE IF NOT EXISTS `MWRData`.`MWTxnDetail` (
  ...
  `WasteCode` VARCHAR(20) NULL,
  `SubWeight` DECIMAL(2) NULL COMMENT '当前交易提交重量',
  `TxnWeight` DECIMAL(2) NULL COMMENT '交易成交重量（实际重量）',
