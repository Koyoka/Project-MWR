...
CREATE TABLE IF NOT EXISTS `MWRData`.`MWInventory` (
  ...
  `DestWeight` FLOAT NULL COMMENT '销毁重量',
...
CREATE TABLE IF NOT EXISTS `MWRData`.`MWTxnRecoverHeader` (
  ...
  `TotalSubWeight` FLOAT NULL COMMENT '回收提交的总重量',
  `TotalTxnWeight` FLOAT NULL COMMENT '交易完成的实际总重量',
...
CREATE TABLE IF NOT EXISTS `MWRData`.`MWInventoryTrack` (
  ...
  `Waste` VARCHAR(45) NULL COMMENT '废品名称',
  `WasteCode` VARCHAR(20) NULL COMMENT '废品编号',
  `SubWeight` FLOAT NULL COMMENT '库存变更的提交重量',
  `TxnWeight` FLOAT NULL COMMENT '库存变更的成交重量',
...
CREATE TABLE IF NOT EXISTS `MWRData`.`MWTxnPostHeader` (
  ...
  `TotalCrateQty` INT NULL COMMENT '交易中箱子的总重量',
  `TotalSubWeight` FLOAT NULL COMMENT '出库提交的总重量',
  `TotalTxnWeight` FLOAT NULL COMMENT '交易完成的实际总重量',
...
CREATE TABLE IF NOT EXISTS `MWRData`.`MWTxnDestroyHeader` (
  ...
  `TotalSubWeight` FLOAT NULL COMMENT '销毁提交的总重量',
  `TotalTxnWeight` FLOAT NULL COMMENT '交易完成的实际总重量',
...
CREATE TABLE IF NOT EXISTS `MWRData`.`MWInvAuthorize` (
  ...
  `SubWeight` FLOAT NULL COMMENT '提交的重量',
  `TxnWeight` FLOAT NULL COMMENT '交易中实际的重量',
  `DiffWeight` FLOAT NULL COMMENT '重量差值',
...
CREATE TABLE IF NOT EXISTS `MWRData`.`MWTxnDetail` (
  ...
  `EmplCode` VARCHAR(20) NULL COMMENT '操作员',
  `CrateCode` VARCHAR(20) NULL,
  `Vendor` VARCHAR(20) NULL COMMENT '供货商（医院）',
  `Waste` VARCHAR(20) NULL COMMENT '医疗废品名称',
  `SubWeight` FLOAT NULL COMMENT '当前交易提交重量',
  `TxnWeight` FLOAT NULL COMMENT '交易成交重量（实际重量）',
