...
CREATE TABLE IF NOT EXISTS `MWRData`.`MWDestroyMCParamsLog` (
  ...
  `Pressure` DECIMAL(10,2) NULL COMMENT '压力',
  `InTemperature` DECIMAL(4,2) NULL COMMENT '内部温度',
  `ExTemperature` DECIMAL(4,2) NULL COMMENT '外部温度',
  `EC1` DECIMAL(10,2) NULL COMMENT 'Electric current 电流 电机1',
  `EC2` DECIMAL(10,2) NULL COMMENT '电流 电机2',
