...
-- 仓库基础数据
DELETE FROM `MWDepot`;
INSERT INTO `MWRData`.`MWDepot` (`DeptCode`, `Total`, `Desc`) VALUES ('CK001', 100, '1号仓库');
INSERT INTO `MWRData`.`MWDepot` (`DeptCode`, `Total`, `Desc`) VALUES ('CK002', 100, '2号仓库');
INSERT INTO `MWRData`.`MWDepot` (`DeptCode`, `Total`, `Desc`) VALUES ('CK003', 100, '3号仓库');
INSERT INTO `MWRData`.`MWDepot` (`DeptCode`, `Total`, `Desc`) VALUES ('CK004', 100, '4号仓库');
INSERT INTO `MWRData`.`MWDepot` (`DeptCode`, `Total`, `Desc`) VALUES ('CK005', 100, '5号仓库');
