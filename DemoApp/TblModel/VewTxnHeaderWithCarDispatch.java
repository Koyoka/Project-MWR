...
public class VewTxnHeaderWithCarDispatch extends BaseDataModule {

    public VewTxnHeaderWithCarDispatch(){
    }
    ...
    public static DataColumnInfo[] Columns = 
        ...
        new DataColumnInfo(false,true,false,false,"DisStatus",DataColumnType.STRING,2)
    };
    ...
    public static final String DISSTATUS_ENUM_ShiftStrat = "S";//班次开始了;
    public static final String DISSTATUS_ENUM_ShiftEnd = "E";//班次完成了;
